    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <section className="py-20 md:py-32">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-10">
              NeuroAI Health provides accessible, AI-powered tests to help you monitor for early signs of neurological conditions like Parkinson's disease, right from home.
            </p>
      ...
      <footer className="border-t border-border py-8">
        <div className="container mx-auto px-6 text-center text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} NeuroAI Health. All rights reserved.</p>
          <p className="text-xs mt-2">
            Disclaimer: NeuroAI Health is not a medical device and should not be used for diagnosis. Always consult with a qualified healthcare professional.
          </p>
        </div>
      </footer>
    </div>
